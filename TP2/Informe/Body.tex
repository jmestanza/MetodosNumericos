...
A continuaci\'on se presentan los c\'odigos implementados para obtener los gr\'aficos que se encuentran m\'as abajo.
...
Aqu\'i se pueden observar gr\'aficamente las soluciones de las EDOs.
\begin{figure}[h!]
\centering
